...
1. **[workshop-guide.md](workshop-guide.md)** - Main workshop guide with all exercises
...
3. **[sample-files-guide.md](sample-files-guide.md)** - Sample files documentation
...
4. **[facilitator-guide.md](facilitator-guide.md)** - Comprehensive facilitator guide
...
5. **[assessment-rubric.md](assessment-rubric.md)** - Assessment criteria
...
1. Read through [`workshop-guide.md`](workshop-guide.md)
2. Complete exercises in order
3. Use [`quick-reference.md`](quick-reference.md) for help
4. Check your progress with [`assessment-rubric.md`](assessment-rubric.md)
5. Practice with bonus challenges

### For Facilitators

1. Review [`facilitator-guide.md`](facilitator-guide.md) thoroughly
2. Complete the pre-workshop checklist
3. Prepare sample files from [`sample-files-guide.md`](sample-files-guide.md)
4. Follow the delivery guide during the workshop
5. Use [`assessment-rubric.md`](assessment-rubric.md) to evaluate participants
6. Collect feedback for continuous improvement

### For Workshop Participants

1. Arrive with prerequisites installed
2. Follow along with [`workshop-guide.md`](workshop-guide.md)
3. Keep [`quick-reference.md`](quick-reference.md) open for reference
...
See [`sample-files-guide.md`](sample-files-guide.md) for complete details and setup instructions.
...
**Ready to master Bob? Start with [`workshop-guide.md`](workshop-guide.md) and begin your journey to AI-assisted development!** 🚀